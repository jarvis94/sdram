...
int main()
{ 
  alt_putstr("Welcome to test bench for SDRAM implemented in NIOS proessor\n");
 short data0 = 0x0000;
 short data1 = 0x1111;
 short data2 = 0x2222;
 short data3 = 0x3333;
 ...
 printf("consecutive read and write operation");
 ...
 printf ("read:address21= [0x%0x]\n", IORD_16DIRECT (MY_SDRAM_0_BASE, 21));
  ...
  IOWR_16DIRECT(MY_SDRAM_0_BASE, 2559, data6);
   ...
   printf("reading all previous written data continuosly");
   ...
   printf("writing continuously and then reading continuously");
   ...
   IOWR_16DIRECT(MY_SDRAM_0_BASE, 3598, data14);
   printf("Writing [0x%x] to address3598 register.\n", data14);
   ...
   printf ("read:address3598	= [0x%0x]\n", IORD_16DIRECT (MY_SDRAM_0_BASE, 3598));
